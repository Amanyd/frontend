      ...
      {/* PostHog Analytics */}{/* Reddit Pixel */}{/* JSON-LD Structured Data */} <div className="bg-bg min-h-screen antialiased overflow-x-hidden" data-astro-cid-j7pv25f6="">  {/* intentionally empty */} <nav className="fixed top-0 left-0 right-0 z-50 w-full border-b border-border bg-bg/95 backdrop-blur-sm" data-nav-inner="" data-astro-cid-5blmo7yk=""> {/* Full-width bar. Inner wrapper matches the main content container
       ...
       rectangle as the compare row below. */}
                  <div className="surfaces-frame grid grid-cols-2 max-lg:grid-cols-1 mb-12 max-md:mb-10" data-astro-cid-4c6nu67j="">
                    ...
                    <a href="/login" className="surface-card surface-card--drenched group relative p-12 max-md:p-7 max-sm:p-6 flex flex-col gap-[22px] max-md:gap-5 border-r border-border max-lg:border-r-0 max-lg:border-b" data-astro-cid-4c6nu67j="">
                      ...
                      <span className="surface-cta surface-cta--inv mt-auto" style={{ borderRadius: '6px' }} data-astro-cid-4c6nu67j="">
                    ...
                    <a href="/login" className="surface-card surface-card--light group relative p-12 max-md:p-7 max-sm:p-6 flex flex-col gap-[22px] max-md:gap-5" data-astro-cid-4c6nu67j="">
                      ...
                      <span className="surface-cta mt-auto" style={{ borderRadius: '6px' }} data-astro-cid-4c6nu67j="">
